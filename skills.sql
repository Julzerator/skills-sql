...
-- left joins and inner joins.
    ...
    -- Left joins will show things even if there is something that is NULL
    -- in one of the tables. Inner joins show all the records even if something
    -- is NULL.
